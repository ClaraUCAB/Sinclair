...
export class AuthHandler {
        ...
        if (registerStatus !== RegisterStatus.Success) {
            const error = (() => {
                switch (registerStatus) {
                    case RegisterStatus.EmailTaken: return 'Email ya tomado.';
                    case RegisterStatus.EmailEmpty: return 'Email no suministrado.';
                    case RegisterStatus.PasswordEmpty: return 'Contraseña no suministrada.';
                    case RegisterStatus.PasswordTooLong: return 'Contraseña demasiado larga';
    ...
    async login(req: Request, res: Response) {
        ...
        if (loginStatus !== LoginStatus.Success) {
            const error = (() => {
                switch (loginStatus) {
                    case LoginStatus.InvalidEmail: return 'Email inválido.';
                    case LoginStatus.WrongPassword: return 'Contraseña incorrecta.';
                    default: return 'Error desconocido.';
                }
            })();
